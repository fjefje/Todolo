...
router.post('/app/list/load', async function(req,res,next){
    ...
    let query = `SELECT * from "public"."alle_lister" WHERE "userid"='${brukerid}'`;
...
router.delete('/app/lists/', async function(req, res) {
    ...
    let queryDeleteListContent = `DELETE FROM "public"."alle_lister" WHERE "listeid" = '${listid}' RETURNING *`;
